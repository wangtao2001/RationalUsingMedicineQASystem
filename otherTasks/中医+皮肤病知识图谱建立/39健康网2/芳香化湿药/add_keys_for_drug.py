...
with open("基本属性.txt",'rt',encoding="utf-8") as f:  
...
for line in lines:
    ...
    keys_list=["【别名】","【汉语拼音】","【名称英】","【成份】","【加工采集】","【药材鉴别】","【药理作用】","【炮制】","【功能主治】","【性味】","【用法用量】","【宜忌】","【贮藏】","【副作用】","【归经】","【备注】","【植物形态】","【临床应用】","【药用部位】","【来自何书】"]
    for i in keys_list:
        if i in dict.keys():
            continue
        else:
...
for j in dict_list:
    print(j)
    with open("芳香化湿药完整属性.txt",'a',encoding="utf-8") as f2:
        f2.write(j)
